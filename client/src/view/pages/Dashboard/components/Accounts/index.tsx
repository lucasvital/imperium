  ...
  return (
    <div className="bg-teal-900 rounded-2xl h-full w-full px-4 py-8 md:p-10 flex flex-col">
      {isLoading && (
        <>
          <div>
            <Skeleton className="w-32 h-4 mb-2 bg-teal-800" variant="text" />
            <div className="flex items-center gap-2">
              <Skeleton className="w-40 h-8 bg-teal-800" variant="text" />
              <Skeleton className="w-8 h-8 bg-teal-800" variant="circular" />
            </div>
          </div>
          <div className="flex-1 flex flex-col justify-end mt-10 md:mt-0">
            <Skeleton className="w-32 h-5 mb-4 bg-teal-800" variant="text" />
            <Swiper
              spaceBetween={16}
